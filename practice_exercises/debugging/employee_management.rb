...
miller_contracting.add becca     # => Employee added.
miller_contracting.add raul      # => Employee added.
miller_contracting.add raul      # => Employee serial number is already in the system.
